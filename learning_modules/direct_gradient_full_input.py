"""
Direct gradient self-nomination with full channel matrix input (straight-through estimator).
"""
import os
import sys
...
class Modules(nn.Module):
    def __init__(self, scheduling_method="random", beamforming_method="zf"):
        super().__init__()
